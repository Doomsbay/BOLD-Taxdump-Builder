...
## Data policy
Large data outputs generated by this pipeline are not committed to GitHub;
...
This repository contains processing scripts and does not host raw BOLD data files in the source tree.

However, the output files generated by this pipeline (including the prebuilt databases provided in GitHub Releases) contain data derived from the [BOLD Public Data Portal](https://www.boldsystems.org/).
...
**Important:**
1. **Derivative Works**: The taxdumps and marker FASTA files are derivative works of the BOLD database.
2. **Terms of Use**: While the scripts are open source, the data within the generated files remains subject to [BOLD's Data Policy and Terms of Use](https://www.boldsystems.org/index.php/Disclaimer).
3. **Citation**: If you use the databases generated by this tool in a publication, you must follow BOLD's citation guidelines for the specific snapshot used (see "Data citation" above).
